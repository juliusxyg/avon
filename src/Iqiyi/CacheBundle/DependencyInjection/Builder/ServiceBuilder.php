...
namespace Iqiyi\CacheBundle\DependencyInjection\Builder;
...
class ServiceBuilder extends BaseBuilder
{
    ...
    protected static $types = array(
        ...
        'memcached' => array(
            'class' => 'Iqiyi\CacheBundle\Cache\Memcached',
            'connect' => 'addServer'
        ),
        'redis' => array(
            'class' => 'Redis',
    ...
    private function buildService($typeId, $name, array $instance)
    {
        ...
        $service  =
            $this->container->setDefinition(
                ...
                new Definition($this->container->getParameter('iqiyi_cache.service.class'))
            )
