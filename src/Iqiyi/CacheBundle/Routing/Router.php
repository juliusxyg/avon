...
namespace Iqiyi\CacheBundle\Routing;

use Iqiyi\CacheBundle\Routing\Matcher\CacheUrlMatcher;
use Symfony\Bundle\FrameworkBundle\Routing\Router as BaseRouter;
use Symfony\Component\DependencyInjection\ContainerInterface;
use Symfony\Component\Routing\RequestContext;
use Iqiyi\CacheBundle\Service\CacheService;
...
class Router extends BaseRouter
{
    ...
    {
        $config   = $this->container->getParameter('iqiyi_cache.router');
        $instance = $config['instance'];

        /** @var CacheService $cache */
        $this->cache = $this->container->get('iqiyi_cache.instance.' . $instance);
    }
